...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2018 at 06:15 AM
...
INSERT INTO `contribute` (`c_id`, `c_uid`, `c_oid`, `c_eid`, `feedback`, `value`, `status`) VALUES
(40, 1, NULL, 12, 'Good one bro!', 8, 1),
(41, 16, NULL, 17, 'Nice one', 7, 1),
(42, 4, NULL, 17, 'Not bad..But you should work hard..', 5, 1),
(43, 5, NULL, 17, '', 0, 0),
(44, 1, NULL, 15, 'ssa', NULL, 0),
(45, 1, NULL, 19, 'sdadada', 5, 1);
...
(19, 8.0407913, 79.83938599999999, 'Kariyamaditta', '<p>jshdjsfsfd</p>\r\n\r\n<p>;lskfas</p>\r\n', 3, 'Beach clening programme', '2018-06-18', '107,Kudagoda,, Kariyamaditta', 'Hambanthota', 16, NULL, 1, 1);
...
('fdG5bbO4D7pwGylOD88O_GpwwgKpFq9u', 1534435073, '{\"cookie\":{\"originalMaxAge\":null,\"expires\":null,\"httpOnly\":true,\"path\":\"/\"},\"passport\":{\"user\":{\"user_id\":1,\"log\":0,\"role\":\"admin\"}}}');
